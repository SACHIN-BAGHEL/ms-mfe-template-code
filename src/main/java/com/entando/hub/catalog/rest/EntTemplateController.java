...
import com.entando.hub.catalog.service.EntTamplateService;
...
public class EntTemplateController {
	...
	public ResponseEntity<EntTemplate> getEntTemplate(@PathVariable String templateId) {
		...
		Optional<com.entando.hub.catalog.persistence.entity.EntTemplate> EntTemplateOptional = entTamplateService.getTemplate(templateId);
	...
	public ResponseEntity<EntTemplate> createEntTemplate(@RequestBody EntTemplate entTemplate) {
		...
		com.entando.hub.catalog.persistence.entity.EntTemplate entity = entTamplateService.createTemplate(entTemplate.createEntity(Optional.empty()));
	...
	public ResponseEntity<EntTemplate> updateEntTemplate(@RequestBody EntTemplate template) {
		...
		Optional<com.entando.hub.catalog.persistence.entity.EntTemplate> templateOptional = entTamplateService.getTemplate(template.getId());
		if (!templateOptional.isPresent()) {
			logger.warn("Template '{}' does not exists", template.getId());
			return new ResponseEntity<>(null, HttpStatus.NOT_FOUND);
		} else {
			com.entando.hub.catalog.persistence.entity.EntTemplate updatedEntity = entTamplateService.createTemplate(null);
	...
	public static class EntTemplate {
		...
		public EntTemplate(com.entando.hub.catalog.persistence.entity.EntTemplate entity) {
		...
		public com.entando.hub.catalog.persistence.entity.EntTemplate createEntity(Optional<String> id) {
			com.entando.hub.catalog.persistence.entity.EntTemplate entity = new com.entando.hub.catalog.persistence.entity.EntTemplate();
